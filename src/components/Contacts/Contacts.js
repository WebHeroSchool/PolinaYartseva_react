...
const Contacts = () => (<div className={styles.wrap}>
    ...
    <div className={styles.content}>
        <div className={styles.item}>
            <img src="Icons/mail.png" alt="e-mail" className={styles.icon} />
            <a className={styles.link} href='mailto:polinayartseva.web@gmail.com'>polinayartseva.web@gmail.com</a>
        </div>
        <div className={styles.item}>
            <img src="Icons/call.png" alt="tel" className={styles.icon} />
        ...
        <div className={styles.item}>
            <img src="Icons/telegram.png" alt="telegram" className={styles.icon} />
            <a className={styles.link} href='https://t.me/Polina_yartseva'>+7-952-710-62-20</a>
        </div>
        <div className={styles.item}>
            <img src="Icons/whatsapp.png" alt="whatsapp" className={styles.icon} />
